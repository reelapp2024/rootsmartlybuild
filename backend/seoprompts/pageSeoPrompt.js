/**
 * Mode 2 — full page meta (title, description, keywords + social fields).
 * Moved from sections/seoprompts for a clean top-level seoprompts package.
 */
...
module.exports = { buildPageSeoPrompt };
