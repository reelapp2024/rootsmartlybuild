...
const CANONICAL_AREAS_SECTION_ORDER = Object.freeze([
...
const CANONICAL_SERVICES_SECTION_ORDER = Object.freeze([
...
const CANONICAL_ABOUT_SECTION_ORDER = Object.freeze([
...
const CANONICAL_CONTACT_SECTION_ORDER = Object.freeze([
...
const CANONICAL_LEGAL_SECTION_ORDER = Object.freeze(["legalhero", "legalcontent"]);



/** Blog index page */

const CANONICAL_BLOG_SECTION_ORDER = Object.freeze(["blogshero", "blogssearch", "blogslist"]);



/** Blog detail template */

const CANONICAL_BLOGDETAIL_SECTION_ORDER = Object.freeze([
...
const MINIMAL_SERVICE_SECTION_FALLBACK = Object.freeze([
...
const SERVICE_DETAIL_SECTION_ALIASES = Object.freeze({
...
function serviceDetailBundleTwinId(sectionId = "") {
...
function resolveCanonicalPageKey(pageKeyOrMeta = "") {
...
function getCanonicalOrderList(pageKey = "home") {
...
function applyCanonicalSectionOrderToPageSections(pageKeyOrMeta, sections = []) {
...
module.exports = {
  ...
  CANONICAL_AREAS_SECTION_ORDER,

  CANONICAL_SERVICES_SECTION_ORDER,

  CANONICAL_ABOUT_SECTION_ORDER,

  CANONICAL_CONTACT_SECTION_ORDER,

  CANONICAL_LEGAL_SECTION_ORDER,

  CANONICAL_BLOG_SECTION_ORDER,

  CANONICAL_BLOGDETAIL_SECTION_ORDER,
  ...
  SERVICE_DETAIL_SECTION_ALIASES,
