...
const websitePageSchema = new Schema({
  ...
  seoSettings: {
    type: [{
      ...
      /** Legacy single JSON-LD blob (kept for older sitenextjs). Prefer schemas[]. */
      structured_data: { type: String, default: "" },
      /**
       * Premium SEO (seo_mode=2): multiple JSON-LD schemas per page.
       * Phase 2 admin CRUD will edit this array.
       */
      schemas: {
        type: [
          {
            ...
            source: { type: String, default: "system" }, // system | ai | manual
