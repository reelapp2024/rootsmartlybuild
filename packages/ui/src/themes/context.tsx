...
import { themes, fonts, FontName } from '../index';
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({
  ...
  useEffect(() => {
    ...
    const cssText = `
      ...
      ${isInBuilder ? `
      /* Scoped heading and text styles for builder webpage content only */
      [data-website-content="true"] h1 {
        font-size: var(--heading-h1-size, 3rem) !important;
      }
      [data-website-content="true"] h2 {
        font-size: var(--heading-h2-size, 2.5rem) !important;
      }
      [data-website-content="true"] h3 {
        font-size: var(--heading-h3-size, 2rem) !important;
      }
      [data-website-content="true"] h4 {
        font-size: var(--heading-h4-size, 1.5rem) !important;
      }
      [data-website-content="true"] h5 {
        font-size: var(--heading-h5-size, 1.25rem) !important;
      }
      [data-website-content="true"] h6 {
        font-size: var(--heading-h6-size, 1rem) !important;
      }
      [data-website-content="true"] p,
      [data-website-content="true"] .text-base {
        font-size: var(--text-size-base, 1rem) !important;
      }
      [data-website-content="true"] .text-small {
        font-size: var(--text-size-small, 0.875rem) !important;
      }
      [data-website-content="true"] .text-large {
        font-size: var(--text-size-large, 1.125rem) !important;
      }
      [data-website-content="true"] .text-xl {
        font-size: var(--text-size-xl, 1.25rem) !important;
      }
      /* CRITICAL: font-family removed - typography is resolved inline per element */
      ` : `
      /* Global styles for custom sites */
      h1 {
        font-size: var(--heading-h1-size, 3rem) !important;
      }
      h2 {
