...
import AreasHero from '@/themes/multicolor/components/areas/AreasHero';
import AreasGrid from '@/themes/multicolor/components/areas/AreasGrid';
import WhyChooseUsSimple from '@/themes/multicolor/components/WhyChooseUsSimple';
...
// import SEOHead from '@/themes/multicolor/components/SEOHead'; // Removed - using Next.js Metadata API instead
...
const AreasPageClient = () => {
  ...
  const seoData = {
    meta_title: 'Service Areas - Professional Services',
    meta_description: 'Find professional services in your area. Available 24/7 with fast response times.'
  };
    ...
    <div className="min-h-screen font-poppins">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-8 lg:px-16">
            ...
            {/* View All Locations Button - Removed since duplicate section is removed */}
...
export default AreasPageClient;
