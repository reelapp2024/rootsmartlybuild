...
const GuaranteeSection = () => {
  ...
  return (
    <section className="py-16 bg-white">
      {/* CLS Fix: Container with fixed min-height to prevent layout shift */}
      <div className="container mx-auto px-4 sm:px-8 lg:px-16" style={{ minHeight: '600px', contain: 'layout style' }}>
        
        {/* Section Header - CLS Fix: Fixed dimensions to prevent layout shift */}
        <div className="text-center mb-12" style={{ minHeight: '180px', textAlign: 'center' }}>
          <div className="inline-block mb-4" style={{ height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
            <span 
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 max-w-3xl mx-auto leading-tight text-center" style={{ minHeight: '80px', textAlign: 'center', display: 'block' }}>
            Our <span style={{ color: colors.primaryButton.bg }}>{projectCategory}</span> Guarantee
          </h2>
          <p className="text-xs sm:text-sm text-gray-600 max-w-3xl mx-auto leading-relaxed mt-6 text-center" style={{ minHeight: '40px', textAlign: 'center' }}>
            {guaranteeText || '\u00A0'}
          </p>
        </div>
