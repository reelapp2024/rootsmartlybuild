...
export const SeasonalSpotlightFunky: React.FC<Props> = ({
  ...
  const titleEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-season-title`) || {
  ...
  const descEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-season-desc`) || {
  ...
  const btnEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-season-btn`) || {
