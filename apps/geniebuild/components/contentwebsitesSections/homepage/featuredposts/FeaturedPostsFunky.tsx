...
export const FeaturedPostsFunky: React.FC<Props> = ({
  ...
  const titleEl = mergeFunkyElement(section, `${section.id}-cw-feat-title`, {
    ...
    <div className="relative w-full overflow-hidden" style={{ backgroundColor: bg }}>
      ...
      <div className={`max-w-7xl mx-auto ${padX} ${padT} ${padB}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map((item, i) => {
            const itemTitle = mergeFunkyElement(section, `${section.id}-cw-feat-item-${i}-title`, {
...
export default FeaturedPostsFunky;
