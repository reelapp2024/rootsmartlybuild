...
export const HeroFunky: React.FC<Props> = ({
  ...
  const badgeEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-hero-badge`) || {
  ...
  const titleEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-hero-title`) || {
  ...
  const descEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-hero-desc`) || {
