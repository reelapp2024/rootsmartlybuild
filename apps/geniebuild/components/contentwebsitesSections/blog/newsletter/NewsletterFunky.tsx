...
export const BlogNewsletterFunky: React.FC<Props> = ({
  ...
  const titleEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-blognews-title`) || {
    id: `${section.id}-cw-blognews-title`, type: 'heading',
  ...
  const descEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-blognews-desc`) || {
    id: `${section.id}-cw-blognews-desc`, type: 'text',
  ...
  const formEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-cw-blognews-form`) || {
    id: `${section.id}-cw-blognews-form`, type: 'newsletter',
...
export default BlogNewsletterFunky;
