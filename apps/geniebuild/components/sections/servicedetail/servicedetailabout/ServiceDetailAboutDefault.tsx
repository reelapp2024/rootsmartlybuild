...
/**
 * ServiceDetailAboutDefault — full copy of AboutServiceConsistent (light
 * "about this service" split), page-specific to the Service Detail page.
 */
export const ServiceDetailAboutDefault: React.FC<Props> = ({
...
export default ServiceDetailAboutDefault;
