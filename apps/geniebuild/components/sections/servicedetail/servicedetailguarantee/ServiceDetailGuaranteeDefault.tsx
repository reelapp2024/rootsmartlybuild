...
/**
 * ServiceDetailGuaranteeDefault — light variant.
 *
 ...
 */
export const ServiceDetailGuaranteeDefault: React.FC<Props> = ({
  ...
  const apiTitleText = String((content as any).title || 'Service Guarantee');
  ...
  const badgeEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-sdgt-badge`) || {
    id: `${section.id}-sdgt-badge`, type: 'badge',
  ...
  const titleEl: WebsiteElement = (() => {
    const id = `${section.id}-sdgt-title`;
  ...
  // Description
  const descEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-sdgt-desc`) || {
    id: `${section.id}-sdgt-desc`, type: 'text',
  ...
  const statEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-sdgt-stat`) || {
    id: `${section.id}-sdgt-stat`, type: 'stat-card',
    content: {
      value: apiStatValue,
      text: apiStatLabel,
      icon: apiStatIcon,
  ...
  const listEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-sdgt-list`) || {
    id: `${section.id}-sdgt-list`, type: 'list',
...
export default ServiceDetailGuaranteeDefault;
