  ...
  return (
    <footer className="w-full relative" style={{ ...bgStyle, backgroundColor: bgStyle.backgroundColor || bg, ['--gb-footer-accent' as any]: accent }}>
      ...
      <div className={`${innerClass} relative`} style={innerStyle}>
        {/* Compact single-row footer: logo left, quick links center, copyright right */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
          {/* Logo left */}
          <div className="relative group/logo inline-block flex-none">
            {logoMode === 'image' ? (
        ...
        <div className="mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4" style={{ borderTop: `1px solid ${dividerCol}` }}>
