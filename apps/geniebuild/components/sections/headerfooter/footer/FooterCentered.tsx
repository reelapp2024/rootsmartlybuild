...
export const FooterCentered: React.FC<Props> = ({
  ...
  const taglineEl = mergeDynamicElement(
    ...
    {  fontSize: '0.875rem', lineHeight: '1.6', maxWidth: '480px', textAlign: 'center' }
  );
  ...
  const quickListEl = mergeDynamicElement(
    ...
    { ...listStyle, orientation: 'horizontal' as any, textAlign: 'center' as any }
  );
  ...
  const legalListEl: WebsiteElement = resolveSectionElement(section, {
    ...
    style: { listType: 'none', orientation: 'horizontal', columns: 1, itemGap: '1.5rem', indent: '0px', fontSize: '0.8125rem', textAlign: 'center' as any } as any,
  });
  ...
  return (
    <footer className="w-full relative" style={{ ...bgStyle, backgroundColor: bgStyle.backgroundColor || bg, ['--gb-footer-accent' as any]: accent }}>
      ...
      <div className={`${innerClass} relative`} style={innerStyle}>
        {/* Everything centered in a stack: logo, tagline, nav row, social, copyright */}
        ...
        {/* Bottom bar: copyright + legal, both centered */}
        <div className="mt-10 pt-6 flex flex-col items-center gap-3" style={{ borderTop: `1px solid ${dividerCol}` }}>
