...
export const HeaderCentered: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div className={`${innerClass} ${verticalPad}`} style={innerStyle}>
        {/* Top row: logo centered, phone (hidden md) on left, CTA on right */}
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4">
          <div className="hidden md:flex flex-none items-center gap-2 justify-self-start" style={{ color: titleColor }}>
          ...
          <div className="flex-none justify-self-end col-start-3">
            <ElementsSection section={{ ...section, elements: [btnEl] }} {...passthrough} />
          </div>
        </div>

        {/* Second row: nav centered below */}
        <div className="mt-2.5 flex justify-center min-w-0 overflow-visible relative z-[110]">
