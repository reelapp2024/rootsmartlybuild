...
export const HeaderMinimal: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div className={`${innerClass} ${verticalPad} flex items-center gap-6`} style={innerStyle}>
        {/* Logo left */}
        ...
        {/* Nav pushed to the right (ml-auto), no phone number */}
        <div className="ml-auto min-w-0 overflow-visible relative z-[110]">
