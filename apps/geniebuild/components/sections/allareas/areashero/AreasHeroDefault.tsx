...
export const AreasHeroDefault: React.FC<AreasHeroProps> = ({
  ...
  // ── Editable elements ───────────────────────────────────────────
  const badgeEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-arh-badge`) || {
  ...
  const descEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-arh-desc`) || {
