      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          return (
            ...
            >
              ...
              <div className="mb-6 relative z-10">
                <ElementsSection 
                  isWrapped={false} 
                  section={{ ...section, elements: [getEl('quote', 'text', { text: item.description || item.quote || item.content || item.text || '' }, { fontStyle: 'italic', opacity: '0.8' })] }} 
                  onElementSelect={onElementSelect} 
                  selectedElementId={selectedElementId} 
                  onElementUpdate={onElementUpdate || (() => {})} 
                  onTextEdit={onTextEdit} 
        ...
        {isSelected && !readOnly && (
          <button 
            ...
            className="border-2 border-dashed border-white/20 hover:border-white/40 hover:bg-white/5 transition flex flex-col items-center justify-center text-slate-400 font-bold uppercase tracking-widest text-xs gap-2 min-h-[200px] rounded-2xl"
          >
