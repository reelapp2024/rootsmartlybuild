...
export const HeroAurora: React.FC<Props> = ({
  ...
  const themeColors = { ...tc, titleColor, textColor, buttonBackgroundColor: btnBg, buttonTextColor: btnText, secondaryButtonBorder: 'rgba(255,255,255,0.2)', secondaryButtonBg: 'rgba(255,255,255,0.06)', secondaryButtonText: titleColor };
