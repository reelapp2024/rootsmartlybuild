...
export const HeroShowcase: React.FC<Props> = ({
  ...
  const badgeEl: WebsiteElement = resolveSectionElement(section, {
    ...
    style: { fontSize: '0.72rem', fontWeight: '700', letterSpacing: '0.12em', textTransform: 'uppercase' as any, padding: '8px 16px', borderRadius: '9999px', textAlign: 'center' as any, backgroundColor: line},
  });
  ...
  const titleEl: WebsiteElement = resolveSectionElement(section, {
    ...
    style: { fontSize: s.titleSize || 'clamp(2.5rem, 6vw, 4.5rem)', fontWeight: '900', lineHeight: '1.05', textAlign: 'center' as any, letterSpacing: '-0.02em' },
  });
  ...
  const descEl: WebsiteElement = resolveSectionElement(section, {
    ...
    style: { textAlign: 'center' as any, maxWidth: '620px', margin: '0 auto' },
  });
