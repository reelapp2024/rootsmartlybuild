...
export const HeroSplit: React.FC<Props> = ({
  ...
  const badgeEl: WebsiteElement = resolveSectionElement(section, {
    ...
    style: { fontSize: '0.72rem', fontWeight: '700', letterSpacing: '0.12em', textTransform: 'uppercase' as any, padding: '8px 16px', borderRadius: '9999px', textAlign: 'left' as any, backgroundColor: surface},
  });
