...
/**
 * ServicesListGuaranteeDefault — light variant.
 *
 ...
 */
export const ServicesListGuaranteeDefault: React.FC<Props> = ({
  ...
  const apiTitleText = String((content as any).title || 'Our Service Guarantee');
  ...
  const titleEl: WebsiteElement = (() => {
    const id = `${section.id}-slgt-title`;
  ...
  const btnEl: WebsiteElement = section.elements?.find(e => e.id === `${section.id}-slgt-btn`) || {
    id: `${section.id}-slgt-btn`, type: 'button',
...
export default ServicesListGuaranteeDefault;
