...
export type SectionType = 'navbar' | 'header' | 'hero' | 'about' | 'features' | 'services' | 'cta' | 'process' | 'footer' | 'testimonials' | 'pricing' | 'image-banner' | 'elements' | 'canvas' | 'canvasShowcase' | 'faq' | 'why-choose-us' | 'guarantee' | 'areas' | 'stats' | 'aboutservice' | 'servicehero' | 'abouthero' | 'missionvision' | 'corevalues' | 'usp' | 'promise' | 'relatedservices' | 'contacthero' | 'contactinfo' | 'contactform' | 'blogshero' | 'blogssearch' | 'blogslist' | 'blogarticlehero' | 'blogcontent' | 'blogauthor' | 'blogcomments' | 'blogrelated' | 'legalhero' | 'legalcontent' | 'sublocations' | 'locationmap' | 'areashero' | 'areastestimonials' | 'areasfaq'
