...
const MAPBOX_TOKEN = process.env.NEXT_PUBLIC_MAPBOX_TOKEN || process.env.VITE_MAPBOX_TOKEN || '';

if (!MAPBOX_TOKEN) {
  console.warn('MAPBOX_TOKEN is not set. Please add NEXT_PUBLIC_MAPBOX_TOKEN or VITE_MAPBOX_TOKEN to your .env file');
}
